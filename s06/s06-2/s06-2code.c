...
double differential_equations(double theta1, double omega1, double theta2, double omega2,
    ...
    double num1 = sin(theta1 - theta2) * (cos(theta1 - theta2) * omega1 * omega1 - omega2 * omega2 + 2 * g * sin(theta2 - theta1));
    double den1 = 2 - cos(theta1 - theta2) * cos(theta1 - theta2);

    *domega1 = num1 / den1;

    double num2 = sin(theta1 - theta2) * (2 * cos(theta1 - theta2) * omega1 * omega1 - omega2 * omega2 + (2 * g * sin(theta1 - theta2) - sin(theta2 - theta1)));
    double den2 = 2 - cos(theta1 - theta2) * cos(theta1 - theta2);
